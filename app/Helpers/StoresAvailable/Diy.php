...
class Diy extends StoreTemplate
{
    ...
    public function get_rate()
    {
        try {
            // get the full stars
            $full_stars = count($this->right_column->xpath("//div[@data-test-id='RatingStars']//i[@title='Full star']"));
            $half_stars = count($this->right_column->xpath("//div[@data-test-id='RatingStars']//i[@title='Half star']"));
